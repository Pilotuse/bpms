export const defaultMenu =  [
  ...
  },
  {
    ...
    children: [
      ...
      // { id: '3-4', path: '/overview/complaint', describer: '投诉中心', icon: 'icon-yunyingzhongxin' },
      { id: '3-5', path: '/overview/document', describer: '文档中心', icon: 'icon-DOC' },
      { id: '3-6', path: '/overview/manual', describer: '使用手册', icon: 'icon-menci' },
      // { id: '3-7', path: '/overview/feedback', describer: '使用反馈', icon: 'icon-zuzhixiaxia' },
      // { id: '3-8', path: '/overview/micchart', describer: '微聊', icon: 'icon-icon_fabu' },
    ]
  },
  {
    id: '4',
  ...
  },
  {
    ...
    children: [
      ...
      { id: '5-2', path: '/overview/apiTest', describer: '接口测试', icon: 'icon-gongyezujian-zhishideng' } ,
      ...
      // { id: '5-7', path: '/overview/webConf', describer: '界面功能管理', icon: 'icon-gongyezujian-kaiguan' },  
    ]
  },
  {
    id: '6',
    ...
    icon: "",
    children: [
      // { id: '6-1', path: '/overview/encryption', describer: '信息加密', icon: 'icon-dingwei' },
      { id: '6-2', path: '/overview/safyTest', describer: '安全考试', icon: 'icon-gaojing' },
      // { id: '6-3', path: '/overview/safetyKnows', describer: '安全知识', icon: 'icon--lumingpai' },
    ]
  },
  {
    id: '7',
    ...
    children: [
      ...
      { id: '7-2', path: '/overview/orderVolume', describer: '工单交易量', icon: 'icon-tubiao-zhuzhuangtu' },
      // { id: '7-3', path: '/overview/onlineUsers', describer: '在线人数', icon: 'icon-charulianjie' },
      // { id: '7-4', path: '/overview/server', describer: '服务器信息', icon: 'icon-xinhao' },
    ]
  }
]